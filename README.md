...
With a running backend server, which can be hosted with [PyWebScrapBook](https://pypi.org/project/webscrapbook/), captured web pages can be further organized with folders, separators, etc.
