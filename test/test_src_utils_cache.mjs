          ...
          case StorageCache: {
            context('when `_serializeObjectNeeded` is truthy', function () {
              it('should store serialized data', async function () {
                const stub = sinon.stub(StorageCache, "_serializeObjectNeeded").value(true);
                const spy = sinon.spy(BaseCache, "_serializeObject");
            ...
            context('when `_serializeObjectNeeded` is falsy', function () {
              it('should store the input data', async function () {
                const stub = sinon.stub(StorageCache, "_serializeObjectNeeded").value(false);
                const spy = sinon.spy(BaseCache, "_serializeObject");
